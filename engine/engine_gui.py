...
for relative in (".", "core", "ui", "utils", "libs", "Scripts"):
...
def main() -> int:
    ...
    config_manager = ConfigManager(runtime_paths.config_dir / "settings.json")
    script_loader = ScriptLoader(runtime_paths.scripts_dir, logger)
